...
specs.OPAMP_A1= ControlSpec.new(0.01,10,"lin",0,0.05,"sec")
specs.OPAMP_D1= ControlSpec.new(0,2,"lin",0,0.1,"sec")
specs.OPAMP_S1= ControlSpec.new(0,1,"lin",0,1,"db")
specs.OPAMP_R1= ControlSpec.new(0.01,10,"lin",0,1,"sec")

specs.OPAMP_A2= ControlSpec.new(0.01,10,"lin",0,0.05,"sec")
specs.OPAMP_D2= ControlSpec.new(0,2,"lin",0,0.1,"sec")
specs.OPAMP_S2= ControlSpec.new(0,1,"lin",0,1,"db")
specs.OPAMP_R2= ControlSpec.new(0.01,10,"lin",0,1,"sec")

specs.OPAMP_A3= ControlSpec.new(0.01,10,"lin",0,0.05,"sec")
specs.OPAMP_D3= ControlSpec.new(0,2,"lin",0,0.1,"sec")
specs.OPAMP_S3= ControlSpec.new(0,1,"lin",0,1,"db")
specs.OPAMP_R3= ControlSpec.new(0.01,10,"lin",0,1,"sec")

specs.OPAMP_A4= ControlSpec.new(0.01,10,"lin",0,0.05,"sec")
specs.OPAMP_D4= ControlSpec.new(0,2,"lin",0,0.1,"sec")
specs.OPAMP_S4= ControlSpec.new(0,1,"lin",0,1,"db")
specs.OPAMP_R4= ControlSpec.new(0.01,10,"lin",0,1,"sec")

specs.OPAMP_A5= ControlSpec.new(0.01,10,"lin",0,0.05,"sec")
specs.OPAMP_D5= ControlSpec.new(0,2,"lin",0,0.1,"sec")
specs.OPAMP_S5= ControlSpec.new(0,1,"lin",0,1,"db")
specs.OPAMP_R5= ControlSpec.new(0.01,10,"lin",0,1,"sec")

specs.OPAMP_A6= ControlSpec.new(0.01,10,"lin",0,0.05,"sec")
specs.OPAMP_D6= ControlSpec.new(0,2,"lin",0,0.1,"sec")
specs.OPAMP_S6= ControlSpec.new(0,1,"lin",0,1,"db")
specs.OPAMP_R6= ControlSpec.new(0.01,10,"lin",0,1,"sec")

specs.HZ1 = ControlSpec.new(1,30,"lin",0,1,"")
specs.HZ2 = ControlSpec.new(1,30,"lin",0,1,"")
specs.HZ3 = ControlSpec.new(1,30,"lin",0,1,"")
specs.HZ4 = ControlSpec.new(1,30,"lin",0,1,"")
specs.HZ5 = ControlSpec.new(1,30,"lin",0,1,"")
specs.HZ6 = ControlSpec.new(1,30,"lin",0,1,"")
